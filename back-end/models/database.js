...
sequelize
  ...
  .catch((error) =>
    console.log({ message: "impossible de se connecter", error: error.message })
...
db.posts.belongsTo(db.users, {
  // le post est relié a un utilisateur
  foreignKey: "userId",
  as: "user",
});
